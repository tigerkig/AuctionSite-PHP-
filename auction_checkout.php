               ...
               <div class="row">
                  <div>
                     ...
                     <div class="col-sm-3">
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title font_style"><i class="fa fa-credit-card credit_pad_right"></i><?php echo $lang_312;  ?></h4>
                           </div>
                ...
                <div class="col-sm-12" id="qrcode_confirm">
                     ...
                     <div class="row">
                     	<a href="cart.php" class="btn btn-primary font_style" style="right:0px !important; bottom:20px !important;position: absolute; "><?php echo $lang_314;  ?></a>
                     </div>
                  </div>
