...
<script type="text/javascript">
	function give_pro_answer(id){
   	$.post("answer_pro_question.php",
		{apqa_id:id},
		function(r){
			$("#full_ajax").html(r);
		}
	...
	function delete_pro_question(id){
		 if(confirm("Are you sure , to delete Question ???")){
		$.post("delete_pro_question.php",{apqa_id:id},function(r){
			if(r==1){
		location.reload();	
	}else{
...
<?php  echo $lang_276; ?>
<?php
$result=getDetails(doSelect("apqa_id,apa_id,ac_id,question,answer,date,ans_status","ambit_pro_qustn_ans",array("vr_id"=>$_SESSION["vendor_id"])));
...
?>
<tr>
<td><a href="product_details.php?id=<?php echo $v["apa_id"]; ?>" style="color:blue;" ><?php echo getProductName($v["apa_id"]);  ?></a></td>
...
<td><a href="javascript:void(0);" onclick="give_pro_answer('<?php echo $v["apqa_id"];  ?>');" title="Click Here To Give Answer"><img src="icon/edit.png" width="13" /></a> <a href="javascript:void(0);" onclick="delete_pro_question('<?php echo $v["apqa_id"];  ?>');" title="Delete"><img src="icon/delete.png" width="19" /></a>
