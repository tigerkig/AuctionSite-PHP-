               ...
               <div class="panel panel-visible" id="spy6">
                  <div class="panel-heading">
                     ...
                     <div class="panel-title">
                        ...
                        <br/>
                        <?php
                           $result=getDetails(doSelect("ass_id,ass_apa_id,cancel_status,ass_ac_id,ass_vr_id,date,shipment_status,quantity, payment_transfer","ambit_shipment_status",array("ass_vr_id"=>$_SESSION["vendor_id"], "shipment_status"=>1, "payment_status"=>1)));
                        ...
                        <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td style="color:blue;">
                                 	<?php 
                                 	if($v["payment_transfer"]==1){
										echo currency().($commission_val * $v["quantity"]); 
									}	
									?>										
								</td>
                                 <td style="color:green;">
                                 	<?php 
                                 	if($v["payment_transfer"]==1){
                                 		echo currency().($balance * $v["quantity"]);
									} 
                                 	?>	
                                 </td>
                              </tr>
