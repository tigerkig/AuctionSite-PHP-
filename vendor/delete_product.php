...
$product_detail 	= getDetails(doSelect1("posting_type,listing_duration,listing_start","ambit_product_add",array("apa_id"=>$_POST["apa_id"])));
$listing_duration   = $product_detail[0]['listing_duration'];
$posting_date		= $product_detail[0]['listing_start'];
