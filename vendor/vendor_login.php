...
function myValidation(){
	...
	$.post("ajax_login_vendr.php",{email:username,password:password},function(r){
		...
		// alert("login failed !")
			toastr.warning("You don't be approved for Seller Yet! </br> Please Wait...")	
		}
	});
}
</script>
...
<input type="text" name="username" id="username" class="gui-input" placeholder="<?php echo $lang_113; ?>" required>
...
<input type="password" name="password" id="password" class="gui-input" placeholder="<?php echo $lang_76; ?>" required>
