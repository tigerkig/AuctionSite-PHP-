					...
					<div class="container">
						<ul class="megamenu " data-transition="slide" data-animationtime="250">
								...
								<div class="sub-menu" style="width: 100%; right: auto;">
																	...
																	<p class="price">
																		...
																		?>
																			<span class="price-new">
																				<?php 
																					$highest_bid_amount = higest_bid_amount($v["apr_apa_id"]);
																					if($highest_bid_amount != 0){
																						echo higest_bid($v["apr_apa_id"]);
																					}
																					else {
																						echo currency1(currency($v["apr_apa_id"]),$price_part[0] - $price_part[2]);
																					}
									...
									<div class="col-md-4">
										...
										<a href="product_feature.php?type=latest" class="title-submenu"><?php echo $lang_1; ?></a>
											<?php					
										$selling_product=getDetails(doSelect1("apa_id,currency","ambit_product_add",array("new_flag" => '1')," ORDER BY posting_date DESC LIMIT 3"));
								...
								<div class="sub-menu" style="width: 100%; display: none;">
									<div class="content">
										...
										<div class="row">
											...
											?>
												<!-- <a href="product/search_product.php?category_id=<?php echo trim($v3["pc_id"]);  ?>" class="title-submenu"><?php echo $v3["pc_name"]; ?></a> -->
												...
												<div class="row">
													<div class="col-md-12 hover-menu">
														<div class="menu">
															...
															?>
																<!-- <li><a href="product/search_product.php?category_id=<?php echo trim($v3["pc_id"]);  ?>&sub_category_id=<?php echo trim($v7["psc_id"]);  ?>"  class="main-menu"><?php echo $v7["psc_name"]; ?></a></li>									 -->
							...
							<li class="hidden-md">
								...
								<a href="auction_product.php"><?php echo $lang_302; ?></a>
