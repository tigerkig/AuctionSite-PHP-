...
<div class="main-container container">
   <ul class="breadcrumb">
      ...
      <li><a href="<?php  echo $_SERVER["REQUEST_URI"]; ?>"><?php echo $lang_300;?></a></li>
   </ul>
   <!--<div class="row">-->
               ...
               <div class="product-layout col-md-3 col-sm-6 col-xs-12 ">
                  <div class="product-item-container">
                     <div class="left-block">
                        ...
                        <!--Sale Label-->
                        <span class="label label-sale" style="top:3px;left:3px"><?php echo $lang_368?></span>
                     </div>
                     <div class="right-block">
                        ...
                        <div class="button-group" style=" display: flex; justify-content: space-between;">
                           <a href="auction_transaction_details.php?id=<?php echo $v5["id"]; ?>"  style="background-color: #3498db;width:100%;text-align:center;border-radius: 3px" class="addToCart" type="button" data-toggle="tooltip"  ><i class="fa fa-gavel fa-2x"></i> <span class="">Details</span></a>
                        </div>
                     </div>
                     <!-- right block -->
                  </div>
