...
function remove_guest_cart(id,key){
	...
	<div class="main-container container">
        ...
        <div id="content" class="col-sm-12">
          <h2 class="title"><?php echo $lang_124; ?> <a href="vendor_details.php?id=<?php echo $_GET["id"]; ?>" title="<?php echo getVendorName($_GET["id"]);  ?>"><font color="brown"><?php echo getVendorName($_GET["id"]);  ?></font></a></h2>
...
$select="avr_id,vr_id,avr_name,comment,rating,date";
$from="ambit_vendor_review";
$where=array("vr_id"=>$_GET["id"]);
...
?>								
                    ...
                    $url='vendor_review.php?'.$query_string;
                    if($page != 1){
                      $prev=$page-1;
                    ?>
