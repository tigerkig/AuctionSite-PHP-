...
function remove_guest_cart(id,key){
	...
	<div class="main-container container">
        ...
        <div id="content" class="col-sm-12">
          <h2 class="title"><?php echo $lang_273; ?> <a href="product.php?id=<?php echo $_GET["id"]; ?>" title="<?php echo getProductName($_GET["id"]);  ?>"><font color="brown"><?php echo getProductName($_GET["id"]);  ?></font></a></h2>
...
$select="apqa_id,ac_id,question,date,answer";
$from="ambit_pro_qustn_ans";
$where=array("apa_id"=>trim($_GET["id"]),"ans_status"=>1);
...
?>								
                    ...
                    $url='question_answer.php?'.$query_string;
                    if($page != 1){
                      $prev=$page-1;
                    ?>
