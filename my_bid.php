...
<div class="main-container container">
   <ul class="breadcrumb">
      ...
      <li><a href="<?php  echo $_SERVER["REQUEST_URI"]; ?>"><?php echo $lang_345; ?></a></li>
   </ul>
      ...
      <div id="content" class="col-md-12 col-sm-12">
         ...
         <div class="products-list row grid">
            <?php
               ...
               $select = "apa_id,apa_vr_id,name,category,  sub_cat,sub_sub_cat,features,description,weight,color,brand,size,currency,price,stock,video,status,selling_price,posting_type,listing_duration, TIME_TO_SEC(TIMEDIFF(listing_duration,NOW())) as diff_time";
                  ...
                  <div class="right-block">
		                     <div class="caption">
		                        ...
		                        <div class="ratings flexRating">
									      <div style="text-align:center"><?php echo $lang_303; ?> <?php echo $v["view_count"];?></div>
