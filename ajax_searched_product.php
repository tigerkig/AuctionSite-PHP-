...
// $select="apa_id,apa_vr_id,name,category,sub_cat,sub_sub_cat,features,description,weight,color,brand,ab_name,size,price,status";
					...
					<div class="product-filter product-filter-bottom filters-panel" >
						<div class="row">
						   ...
						   <div class="short-by-show text-center col-md-7 col-sm-8 col-xs-12">
								<div class="form-group" style="margin: 7px 10px"><?php echo $lang_309; ?> <?php echo $aa=$pageLimit+1;  ?> to <?php echo $bb=($aa+$page_item)-1;  ?> of <?php echo $total_item;  ?> (<?php echo $total_page;  ?> Pages)</div></div>
