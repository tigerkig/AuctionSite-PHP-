...
echo 'Total Price : '.currency1($v["currency"],$price[0]).'<br/>Tax : '.currency1($v["currency"],$price[1]).'<br/>Discount : '.currency1($v["currency"],$price[2]).'<br/>Shipping Cost : '.currency1($v["currency"],$price[3]);if($v['posting_type'] == 1) echo '<br/>Reserve price : '.currency1($v["currency"],$v["reserve_price"]);
?></td>
</tr>
<?php
...
<span class="fa fa-tag"></span> See Photo
</button>
</a>
</div>
<?php
