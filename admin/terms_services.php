...
$_SESSION["sub_menu"]  = "terms_services";
...
<?php
$terms=getDetails(doselect1("id,terms","ambit_terms_condition",array()));
?>
<span class="panel-title">
Terms & Conditions &nbsp <?php if(!empty($terms)) { ?> <a href="javascript:void(0);" title="Edit" onclick="edit_terms('<?php echo $terms[0]["id"];  ?>');"><img src="icon/edit.png" width="15" /></a><?php } ?>
</span>
</div>
<div class="panel-body pn">
<span style="text-decoration:none;color:blue;">Description:</span>
<p style="text-align: justify;">
<?php if(!empty($terms)) echo $terms[0]["terms"]; else echo '<font color="red">Please write about above !</font>';  ?>
</p>
</div>
