...
<div class="of-h">
<img src="../vendor/product_photo/<?php echo $v["image"];  ?>" class="img-responsive" title="<?php  echo getProductName($v["api_apa_id"]); ?>"  width="200" height="200">
...
function approve_image(api_id){
	//alert(api_id);
	$.post("photo_approve.php",{api_id:api_id},function(r)
	{
		if(r==1){
