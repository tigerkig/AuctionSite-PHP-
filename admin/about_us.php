...
<?php
$about=getDetails(doselect1("about,image,id","ambit_about",array()));
?>
<span class="panel-title">
About Us &nbsp <?php if(!empty($about)) { ?> <a href="javascript:void(0);" title="Edit" onclick="edit_about('<?php echo $about[0]["id"];  ?>');"><img src="icon/edit.png" width="15" /></a><?php } ?>
</span>
</div>
...
<div class="panel-body pn">
<span style="text-decoration:none;color:blue;">Image:</span>
<p style="text-align: justify;">
