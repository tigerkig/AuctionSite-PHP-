   ...
   <div class="" id="register" role="tabpanel">
      <div class="panel">
         <div class="panel-heading">
            ...
            Update <?php echo ucfirst(seeMoreDetails("send_to","mail_body_settings",array("mbs_id"=>$_POST["id"])));  ?>
            </span>
         </div>
         <form method="post" action="javascript:void(0);"   enctype="multipart/form-data" onsubmit="return validation();">
            <div class="panel-body pn">
               <div class="section">
                  ...
                  <textarea name="field" id="field"  rows="5" cols="100"><?php  echo get_mail_settings($_POST["id"]); ?></textarea>
                  </label>
               </div>
               <div class="section">
