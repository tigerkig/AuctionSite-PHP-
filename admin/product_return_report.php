<?php
   ...
   $_SESSION["sub_menu"]  = "product_return_report";
...
<section id="content_wrapper">
                  ...
                  <div class="panel">
                     ...
                     <div class="panel-body">
                        <?php
                           ...
                           ?>
                        <form method="post" action="product_return_report.php" id="" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="section">
                                    <label class="field prepend-icon">
                                    <input type="text" name="from_date" value="<?php echo $from_date; ?>" id="from_date" class="gui-input" placeholder="From Date">
                              ...
                              <div class="col-md-4">
                                 <div class="section">
                                    <label class="field prepend-icon">
                                    <input type="text" name="to_date" value="<?php echo $to_date; ?>" id="to_date" class="gui-input" placeholder="To Date">
   ...
   function changeDate(id){
   	 	if(confirm("Are you sure?")){
		   	...
		   	$.post("ajax_return_approve_date.php",{arp_id:id,date:change_date},function(r){
		   		if(r==1){	   
                  ...
                  <div class="panel-title hidden-xs">
                     ...
                     <?php
                        ...
                        if(isset($_POST["submit"])){
                        	...
                        	$sub_query.=" AND arp_vr_id=".trim($_POST["ass_vr_id"]);
                        	}
                        }
                        $con=array();
                        $select="arp_id,arp_ass_id,arp_apa_id,arp_ac_id,arp_vr_id,date,approve_date, status,return_status,quantity";
                        ...
                        <tbody>
                           <?php
                              foreach($result as $k=>$v){
                              	$return_price = seeMoreDetails("price","ambit_shipment_status",array("ass_id"=>$v["arp_ass_id"]));  
                              ?>
                           <tr>
                              ...
                              <td>
                             	<input class="approve_date" id='<?php echo "date_".$v["arp_id"];?>' value='<?php echo $v["approve_date"];  ?>'> 
                             	
                             	<a href="javascript:void(0);" onclick="changeDate('<?php echo $v["arp_id"];?>');" title="Return Date Change"><img src="icon/tick1.png" width="20"></a>
                             </td>
                              <?php
                                 if($v["status"]==0){
                                 	$status="Refunded";
                              ...
                              <td><?php echo get_currency().$return_price;  ?></td>
                              <?php
