...
if(isset($_SESSION["id"]) && $_SESSION["username"]){
	...
	$_SESSION["sub_menu"]  = "product_sale_report";
						...
						<div class="allcp-form">
							<div class="panel">
								...
								<div class="panel-body">
									...
									<form method="post" action="product_sale_report.php" id="" enctype="multipart/form-data">
				...
				<div class="panel panel-visible" id="spy6">
					<div class="panel-heading">
						<div class="panel-title hidden-xs">
							...
							$select="ass_id,ass_apa_id,cancel_status,ass_ac_id,ass_vr_id,date,shipment_status,payment_status, quantity";
