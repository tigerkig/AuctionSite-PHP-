...
<?php
   ...
   $_SESSION["sub_menu"]  = "review_approve";
...
<script type="text/javascript">
   ...
   function delete_review(id){
   	...
   	$.post("delete_review.php",{apr_id:id},function(r){
   		if(r==1){
   	window.location="review_approve.php";	
   }else{
   	alert("Something went wrong !");
                           ...
                           <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                              <thead>
                                 <tr>
                                    ...
                                    <th class="va-m">Review By</th>
                                    <th class="va-m">Rating</th>
                                    <th class="va-m">Comment</th>
                              ...
                              <tbody>
                                 <?php
                                    ...
                                    ?>
                                 <tr>
                                    <td><?php echo getProductName($v["apr_apa_id"]);  ?></td>
                                    <td><?php echo ucfirst($v["apr_name"]);  ?></td>
                                    <td><?php  echo $v["rating"]; ?></td>
                                    <td><?php  echo substr($v["comment"],0,30).'...............'; ?></td>
                                    <td><?php  echo date("jS F, Y",strtotime($v["date"])); ?></td>
                                    <td><?php if($v["status"]==1)echo '<img src="icon/tick1.png" width="20">';else echo '<img src="icon/cross.png" width="20">';  ?> <a href="javascript:void(0);" onclick="changeStatus('<?php echo $v["apr_id"];  ?>');" title="Change Status"><img src="icon/edit.png" width="13" /></a> <a href="javascript:void(0);" onclick="delete_review('<?php echo $v["apr_id"];  ?>');" title="Delete"><img src="icon/delete.png" width="19" /></a>
                                       <a href="javascript:void(0);" onclick="show_review('<?php echo $v["apr_id"];  ?>');" title="Show Review"><img src="icon/view.png" width="19" /></a>
                                    </td>
                                 </tr>
                                 <?php
                                    }
