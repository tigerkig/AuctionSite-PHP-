...
$(document).ready(function() {
    ...
    //alert('sidd');
var aas_slider=$("#slider_img").val();	
var aas_link=$("#aas_link").val();
    if(aas_slider.trim()==""){
	alert("Slider Image Required!");
	return false;
    }
	$.ajax({
        	url: "ajax_post_slider.php",
			type: "POST",
...
<!-- <input type="file" id="slider_img" name="aas_slider" value=""  style="width: 917px; height: 40px;" /> -->
<input class="button" type="file" id="slider_img" name="aas_slider" value=""/>
<!-- </label> -->
</div>
<br/>
<div class="section">
<!-- <label for="link" class="field prepend-icon"> -->
<!-- <input type="text" id="aas_link" name="aas_link" value="" placeholder="Link URL" style="width: 917px; height: 40px;" /> -->
<input class="form-control" type="text" id="aas_link" name="aas_link" value="" placeholder="Link URL"/>
<!-- </label> -->
</div>
<br/>
...
Slider List
<?php
$result=getDetails(doSelect1("aas_id,aas_slider,aas_link,status","ambit_add_slider",array()));
...
<tr>
<td><?php  echo $i; ?></td>
<td><img src="../image/demo/slider/<?php echo $v["aas_slider"] ?>" width="100px" ></td>
<td><?php echo $v["aas_link"];  ?></td>
<td><div class="section">
<label for="link" class="field prepend-icon">
<input list="browsers" id="product_link<?php echo $v["aas_id"];  ?>" name="product_link" value="" placeholder="Type Product Name" style="height: 40px; width: 180px;">
...
<td><?php if($v["status"]==1)echo '<img src="icon/tick1.png" width="20">';else echo '<img src="icon/cross.png" width="20">';  ?><a href="javascript:void(0);" onclick="changeStatus('<?php echo $v["aas_id"];  ?>');" title="Change Status"><img src="icon/edit.png" width="13" /></a><a href="javascript:void(0);" onclick="delete_product('<?php echo $v["aas_id"];  ?>');" title="Delete Slider"><img src="icon/delete.png" width="22" /></a><a href="javascript:void(0);" onclick="doUpdate('<?php echo $v["aas_id"];  ?>');"><img src="icon/update.png" title="Update" width="18" /></a>
</td>
</tr>
<?php
$i++;
