               ...
               <div class="panel">
                  ...
                  <div class="panel-body">
                     <form method="post" action="javascript:void(0);" id="ajax_des" enctype="multipart/form-data">
                        ...
                        <div class="row add_feat" id="id_7">
                           <?php
                           ...
                           <div class="col-md-12">
                              <div class="col-md-5">
                                 <?php echo $lang_157;  ?> :
                                 <div class="section"><label class="field prepend-icon"><input type="text" name="features_heading[]" id="features_heading" class="gui-input" placeholder="Features Heading" value="<?php  echo $feat[0]; ?>" >
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-5">
                                 <?php echo $lang_158;  ?> :
                                 <div class="section"><label class="field append-icon"><input type="text" name="features_desc[]" id="features_desc" class="gui-input" placeholder="Features Description" value="<?php  echo $feat[1]; ?>" >
                                    </label>
                                 </div>
                              </div>
                        ...
                        <div class="row add_feat1" id="id_6">
                           <div class="col-md-6">
                              <?php echo $lang_53;  ?> :
                              <?php
                           ...
                           <div class="col-md-12">
                              <div class="col-md-6">
                                 <div class="section"><label class="field prepend-icon"><input type="number" step="0.01" name="weight[]" id="weight" class="gui-input" placeholder="Weight" value="<?php echo $weights_detls[0]; ?>" >
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-4">
                        ...
                        <div class="row add_feat2" id="id_5">
                           <div class="col-md-6">
                              <?php echo $lang_95;  ?> :
                              <?php
                        ...
                        <div class="row add_feat3" id="id_4">
                           <?php
                        ...
                        <div class="row" id="id_2">
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="section">
                                 ...
                                 <?php
                                    ...
                                    ?>
                                 <input type="number" step="0.01" name="price[]" id="price" class="gui-input" placeholder="Price" value="<?php echo $price[0];  ?>" required>
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-4">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="number" step="0.01" name="price[]" id="tax" class="gui-input" placeholder="Price-Tax" value="<?php echo $price[1];  ?>" >
                                 </label>
                              </div>
                           </div>
                           <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="section">
                                 <label class="field">
                                 <input type="number" name="price[]" id="shipping" step="0.01" class="gui-input" placeholder="<?php echo $lang_168;  ?>" value="<?php echo $price[3];  ?>" >
                                 </label>
                              </div>
                           </div>
                        </div>
                        <div class="row" style="margin-bottom:10px;">
                           <div id="ajax_select_type" <?php if($v6["posting_type"]==0){  ?> style="display:none;" <?php } ?> >
                              ...
                              <div class="col-md-4" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="listing_start" value="<?php echo $v6['listing_start']; ?>" id="listing_start" class="gui-input" placeholder="" required>
                                    </label>
                                 </div>
                              </div>
                              <div class="col-md-4" style="background-color:#1e6dd4cc;color:yellow;font-size: 1.2em;">
                                 ...
                                 <div class="section">
                                    <label class="field">
                                    <input type="text" name="listing_duration" value="<?php echo $v6['listing_duration']; ?>" id="listing_duration" class="gui-input" placeholder="" required>
                                    </label>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12" id="ajax_photo">
                              <div class="clearfix"></div>
                              <?php
                              ...
                              <div class="col-md-2" style="padding-left:0px">
                                 <div  style="position: relative;width:200;">
                                    ...
                                    <a href="../vendor/product_photo/<?php echo $v["image"];  ?>"><img src="../vendor/product_photo/<?php echo $v["image"];  ?>" height="100px" width="100px"  /></a>
                                    <a href="javascript:void(0);" onclick="delete_image('<?php echo $v["api_id"];?>');" title="Delete"><img src="icon/cross.png" style="position: absolute; top:0; left: 800;height:15px;width:15px; right:25px" /></a>
                                 </div>
                              </div>
                              <?php
                                 }
                        ...
                        <div style="margin-top:2%"><input class="btn btn-default btn-primary" type="submit" name="submit" value="<?php echo $lang_177;  ?>" ></div>
                     </form>
                  </div>
                  <?php
                     }
