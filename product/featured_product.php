            ...
            <div class="ltabs-items <?php if($k3==0) echo "ltabs-items-selected";  ?> items-category-<?php echo $v3["pc_id"];  ?> grid" data-total="10">
               <div class="ltabs-items-inner ltabs-slider ">
                  <?php
                     ...
                     $select="apa_id,apa_vr_id,name,category,sub_cat,sub_sub_cat,features,description,weight,color,brand,size,currency,price,status,stock, view_count,listing_start, TIME_TO_SEC(TIMEDIFF(listing_duration,NOW())) as diff_time";
